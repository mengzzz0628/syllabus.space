...
ok( biosave('instructor@gmail.com', \%bioinstructor), 'written biodata for instructor' );
...
ok( msgsave($c[0], { subject => 'Test Welcome', body => 'Welcome to the testing site.  Note that everything is public and nothing stays permanent here.  I often replace the testsite with a similar new one.', priority => 5 }, 1233), 'posting 1233' );
...
ok( gradesave($c[0], 'student@gmail.com', 'midterm', 'badfail' ), "grade midterm for student");
