...
<ul>
  ...
  Instructors can ignore facilities that they are not interested in.  Students can enroll in courses only with an instructor-set coursesecret when set (or any if none set).  The typical installation has an open corporate finance course for student self-testing.
  </dd>
