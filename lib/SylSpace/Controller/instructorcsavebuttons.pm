#!/usr/bin/env perl
package SylSpace::Controller::instructorcsavebuttons;
use Mojolicious::Lite;
use lib qw(.. ../..); ## make syntax checking easier
use strict;

use SylSpace::Model::Model qw(sudo csetbuttons);
use SylSpace::Model::Controller qw(global_redirect standard);

################################################################

get '/instructor/csavebuttons' => sub {
  my $c = shift;
  ...
  csetbuttons( $subdomain, \@buttonlist ) or return global_redirect($c);
