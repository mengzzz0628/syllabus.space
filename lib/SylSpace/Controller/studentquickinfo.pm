...
use SylSpace::Model::Model qw(sudo userisenrolled cioread hassyllabus);
...
<h1>Quick Course Facts</h1>
  ...
  <table class="table" style="width: auto !important; margin: 2em;">
    ...
    <tr> <th> Syllabus </th> <td> <% my $s=$requestsyllabus; %> <%== (defined($s)) ? qq(<a href="/student/view?f=$s">syllabus</a>): 'n/a' %> </td> </tr>
  </table>
