...
get '/instructor/msgcenter' => sub {
  ...
  $c->stash( msgstring => msghash2string( msgread( $subdomain ), "/msgmarkread", \@msglistread, tzi($c->session->{uemail}) ) );
};
		...
		<div class="col-sm-12">
			<form class="form-horizontal" method="POST" action="msgsave">
				...
				<div class="form-group">
					...
					<option value="4">Top</top>
					<option value="3">High</top>
					<option value="2">Higher</top>
					<option value="1" selected="selected">Normal</top>
					</select>
				</div>
				...
				<div class="form-group">
					<button class="btn btn-lg"  type="submit" value="submit">Submit This Message</button>
				</div>
			</form>
		</div> <!-- col-sm-12 -->
	</div> <!-- row -->
